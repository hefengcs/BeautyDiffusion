...
class CelebAConditionalDataset(Dataset):
    ...
    def __init__(self,
        ...
        # image_folder = 'datasets/MT-Dataset/makeup_nearest256',
        # # text_file = 'datasets/text/captions_hq_beard_and_age_2022-08-19.json',
        # text_file = 'datasets/MT-Dataset/makeup_text/captions.json',
        # # mask_folder = 'datasets/mask/CelebAMask-HQ-mask-color-palette_32_nearest_downsampled_from_hq_512_one_hot_2d_tensor',
        # mask_folder = 'datasets/MT-Dataset/rgb_mask/makeup_haveeye',
        # # sketch_folder = 'datasets/sketch/sketch_1x1024_tensor',
        # sketch_folder = 'datasets/MT-Dataset/rgb_mask/makeup_haveeye',

        #if add
        # image_folder = 'datasets/image/image_512_downsampled_from_hq_1024',
        image_folder = 'datasets/MT-Dataset/face_add_Makeup_Haveeye_image',
        # text_file = 'datasets/text/captions_hq_beard_and_age_2022-08-19.json',
        text_file = 'datasets/MT-Dataset/makeup_text/captions_face_add_Makeup_Haveeye_image.json',
        # mask_folder = 'datasets/mask/CelebAMask-HQ-mask-color-palette_32_nearest_downsampled_from_hq_512_one_hot_2d_tensor',
        mask_folder = 'datasets/MT-Dataset/face_add_Makeup_Noeyenoise_rgb_mask',
        # sketch_folder = 'datasets/sketch/sketch_1x1024_tensor',
        sketch_folder = 'datasets/MT-Dataset/face_add_Makeup_Haveeye_rgb_mask',
        ):
