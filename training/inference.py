...
class Inference:
    ...
    def transfer(self, source: Image, reference: Image, postprocess=True):
        ...
        # source_mask = source_input[2]
        # reference_mask = reference_input[2]
        ...
        torch.save(source_input,'/home/hefengcs/makeup/demo/EleGANt/assets/pt/source.pt')
        torch.save(reference_input, '/home/hefengcs/makeup/demo/EleGANt/assets/pt/reference.pt')
